...
class Whats:
    ...
    def setting_up_chrome(self):
        ...
        try:
            ...
            self.print_parser("ERROR: You need to install a corresponding version of the Chrome driver at http://chromedriver.chromium.org/downloads", error=True, finalize=True)
    ...
    def setting_up_firefox(self):
        ...
        try:
            ...
            self.print_parser("ERROR: You need to install the lastest version of gecko driver at: https://github.com/mozilla/geckodriver/releases", error=True, finalize=True)
